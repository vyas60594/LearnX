    ...
    return (
        <section className="py-24 bg-slate-50">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center border border-slate-200 p-12 rounded-[3.5rem] glass shadow-2xl shadow-primary/5">
                ...
                <button onClick={registerClick} className="bg-navy text-white px-10 py-5 rounded-2xl font-black text-lg flex items-center justify-center gap-3 mx-auto hover:bg-slate-800 transition-all shadow-xl hover:-translate-y-1 active:scale-95 group">
                    Create Free Account
