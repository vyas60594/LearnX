...
const Hero = () => {
    return (
        <section className="relative overflow-hidden lg:py-0">
                ...
                <div className="grid lg:grid-cols-[1fr_1.4fr] gap-12 lg:gap-20 items-center">
                    <div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Link to="/Login" className="bg-navy text-white px-8 py-4 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-slate-800 transition-all shadow-xl hover:shadow-2xl active:scale-95 group">
                                Start Learning
