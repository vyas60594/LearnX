...
const mockTestData = {
    ...
    duration: "30 mins",
    questions: [
        { id: 1, text: "What is the virtual DOM in React?", type: "Multiple Choice", difficulty: "Medium" },
        { id: 2, text: "Explain the useEffect dependency array.", type: "Short Answer", difficulty: "Hard" },
    ]
};
...
const AdminPracticeTestEditor = () => {
    ...
    // In a real app we'd fetch the test data based on the ID.
            ...
            <div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div className="flex gap-3">
                        ...
                        <button className="bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2.5 rounded-xl font-bold shadow-md shadow-emerald-500/20 transition-all flex items-center gap-2">
                    ...
                    {test.questions.map((q, index) => (
                        <div key={q.id} className="group bg-white flex items-start sm:items-center gap-4 p-4 border border-slate-200 rounded-xl hover:border-emerald-500/30 shadow-sm transition-all flex-col sm:flex-row">
                            ...
                            <div className="flex-1 w-full">
                                ...
                                <h3 className="font-bold text-slate-800 text-base">{q.text}</h3>
